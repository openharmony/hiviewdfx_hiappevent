...
int64_t UserIdDao::Insert(const std::string& name, const std::string& value)
{
...
int64_t UserIdDao::Update(const std::string& name, const std::string& value)
{
    if (dbStore_ == nullptr) {
        return DB_FAILED;
    }
...
int UserIdDao::Delete(const std::string& name)
{
    if (dbStore_ == nullptr) {
        return DB_FAILED;
    }
...
int UserIdDao::Query(const std::string& name, std::string& out)
{
    if (dbStore_ == nullptr) {
        return DB_FAILED;
    }
...
int UserIdDao::QueryAll(std::unordered_map<std::string, std::string>& out)
{
    if (dbStore_ == nullptr) {
        return DB_FAILED;
    }
