 ...
 */
#ifndef HIAPPEVENT_INTERFACES_NATIVE_INNER_API_INCLUDE_BASE_TYPE_H
#define HIAPPEVENT_INTERFACES_NATIVE_INNER_API_INCLUDE_BASE_TYPE_H
...
struct ReportConfig {
    ...
    /* Configuration name to be loaded for settings */
...
#endif // HIAPPEVENT_INTERFACES_NATIVE_INNER_API_INCLUDE_BASE_TYPE_H
